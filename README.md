...
проверка `build-and-test`, актуальность относительно `main` и минимум одно
одобрение другого ревьюера. При новых коммитах прежние одобрения сбрасываются. Обход правил администраторами, force push и удаление
